...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  String email,password,firstName,tele,address,lastName;
...
//register customer is here .........................................
  Widget _registerCustomer() {
    return Container(
      ...
      child: RaisedButton(
        ...
        onPressed: () async{
          try{
            userRegister();
            _fStore.collection('users').doc(email).set({
