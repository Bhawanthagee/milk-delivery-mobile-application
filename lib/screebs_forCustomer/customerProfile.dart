...
class _CustomerProfileState extends State<CustomerProfile> {
  ...
  Future getUserDetails()async{
    ...
    DocumentSnapshot userDetails=await _fireStore.collection('users').doc(loggedInUSer.email).get();
    DocumentSnapshot userDetails2=await _fireStore.collection('users').doc(loggedInUSer.email).get();
